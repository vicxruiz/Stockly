...
class StockController {
    ...
    var chart: [Chart] = []
    var stock: Stock?
    var techStocks: [Stock] = []
    var techQuote: Quote?
    var techNews: [News] = []
    var techChart: [Chart] = []
    var healthStocks: [Stock] = []
    var industrialStocks: [Stock] = []
    ...
    func fetchStock(_ stock: Stock, completion: @escaping (Error?) -> Void) {
        //forms url
        var components = URLComponents()
        components.scheme = "https"
        components.host = "cloud.iexapis.com"
        components.path = "/stable/stock/\(stock.symbol.lowercased())/batch"
